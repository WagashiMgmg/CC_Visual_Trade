...
<ol>
  ...
  <li><strong>週足RSI過売れ時の利益目標圧縮</strong>: 週足RSI25-30でショート時、利益目標を次サポートの50-70%に縮小。 <small class="rule-stat">適用3 / WIN1</small></li>
</ol>
...
<ol>
  ...
  <li><strong>マルチTF DC収束ショート</strong>: マクロ三足下降＋15m/30m/1h DC収束でショート。5m: DC or 弱いGC（RSI≤55）、かつ5m RSI≤65必須。15m RSI 40-60、1h RSI≤55下降中。日足RSI≥50上昇中は禁止。<span class="rule-source">出典: Hill, A. SSRN 3412429. / Brock et al. (1992). JF, 47(5), 1731-1764.</span> <small class="rule-stat">適用5 / WIN2</small></li>
